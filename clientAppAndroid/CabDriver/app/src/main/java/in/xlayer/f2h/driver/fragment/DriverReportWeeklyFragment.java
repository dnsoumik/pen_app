...
public class DriverReportWeeklyFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View layoutInflater = inflater.inflate(R.layout.fragment_driver_report_weekly,
                container, false);
        ...
        try {
            JSONObject indexData = DriverReportActivity.WEEKLY_REPORT_DATA
                    .getJSONArray("data").getJSONObject(0);
//            Log.e("DriverWeeklyFragment", "onCreateView: " + indexData );
