...
# Web Socket Protocol for handlling Websocket Connections
class WebSocketProtocol(object):
    ...
    def acceptConnection(self):
        ...
        try:
            ...
            self.handler.closeConnection(403)
            return
        self.transport.write(
...
class WebSocketProtocol17(WebSocketProtocol):
    ...
    def acceptConnection(self):
        Log.i('WS-SOC', 'Using ws spec (draft 17)')
...
class WebSocketProtocol76(WebSocketProtocol):
    ...
    def acceptConnection(self):
        if "Sec-Websocket-Key1" not in self.request.headers or \
            ...
            Log.i('WS-SOC', 'Using old ws spec (draft 75)')
            ws_origin_header = "WebSocket-Origin"
            ws_location_header = "WebSocket-Location"
            self._protocol = 75
        else:
            Log.i('WS-SOC', 'Using ws draft 76 header exchange')
    ...
    def rawDataReceived(self, data):
        ...
        try:
            ...
            Log.i('WS-SOC', "Invalid WebSocket data: %r" % e)
